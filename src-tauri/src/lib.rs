...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::providers::providers_create_server_line,
            commands::providers::providers_update_server_line,
            commands::providers::providers_select_server_line,
            commands::providers::providers_delete_server_line,
